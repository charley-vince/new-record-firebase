...
import {saveWdata} from '../actions/common'
formToWizard($)
          ...
          <fieldset>
            ...
            <div className="form-group col-md-12">
              ...
              <div className="about-wedding form-group col-md-8">
                ...
                <textarea rows="7" name="info-1" className="form-control" />
                <label htmlFor="info-2">{strings.aboutWedding['info-2']}</label>
                <textarea rows="7" name="info-2" className="form-control" />
                <label htmlFor="info-3">{strings.aboutWedding['info-3']}</label>
                <textarea rows="7" name="info-3" className="form-control" />
                <label htmlFor="info-4">{strings.aboutWedding['info-4']}</label>
                <textarea rows="7" name="info-4" className="form-control" />
                <label htmlFor="info-5">{strings.aboutWedding['info-5']}</label>
                <textarea rows="7" name="info-5" className="form-control" />
              </div>
            </div>
          </fieldset>
          ...
          <fieldset>
            ...
            <div className="step-form col-md-12">
              <div className="details col-md-8 col-md-offset-2">
                ...
                <textarea rows="7" name="details-1" className="form-control" />
                <label htmlFor="info-2">{strings.details['info-2']}</label>
                <textarea rows="7" name="details-2" className="form-control" />
                <label htmlFor="info-3">{strings.details['info-3']}</label>
                <textarea rows="7" name="details-3" className="form-control" />
                <label htmlFor="info-4">{strings.details['info-4']}</label>
                <textarea rows="7" name="details-4" className="form-control" />
                <label htmlFor="info-5">{strings.details['info-5']}</label>
                <textarea rows="7" name="details-5" className="form-control" />
                <label htmlFor="info-6">{strings.details['info-6']}</label>
                <textarea rows="6" name="details-6" className="form-control" />

                <label htmlFor="info-7">{strings.details['info-7']}</label>
                <textarea rows="7" name="details-7" className="form-control" />

                <label htmlFor="info-8">{strings.details['info-8']}</label>
                <textarea rows="7" name="details-8" className="form-control" />

                <label htmlFor="info-9">{strings.details['info-9']}</label>
                <textarea rows="7" name="details-9" className="form-control" />

                <label htmlFor="info-10">{strings.details['info-10']}</label>
                <textarea rows="7" name="details-10" className="form-control" />

                <label htmlFor="info-11">{strings.details['info-11']}</label>
                <textarea rows="7" name="details-11" className="form-control" />

                <label htmlFor="info-12">{strings.details['info-12']}</label>
                <textarea rows="7" name="details-12" className="form-control" />

                <label htmlFor="info-13">{strings.details['info-13']}</label>
                <textarea rows="7" name="details-13" className="form-control" />

                <label htmlFor="info-14">{strings.details['info-14']}</label>
                <textarea rows="7" name="details-14" className="form-control" />

                <label htmlFor="info-15">{strings.details['info-15']}</label>
                <textarea rows="7" name="details-15" className="form-control" />

                <label htmlFor="info-16">{strings.details['info-16']}</label>
                <textarea rows="7" name="details-16" className="form-control" />

                <label htmlFor="info-17">{strings.details['info-17']}</label>
                <textarea rows="7" name="details-17" className="form-control" />

                <label htmlFor="info-18">{strings.details['info-18']}</label>
                <textarea rows="7" name="details-18" className="form-control" />

                <label htmlFor="info-19">{strings.details['info-19']}</label>
                <textarea rows="7" name="details-19" className="form-control" />

                <label htmlFor="info-20">{strings.details['info-20']}</label>
                <textarea rows="7" name="details-20" className="form-control" />

                <label htmlFor="info-21">{strings.details['info-21']}</label>
                <textarea rows="7" name="details-21" className="form-control" />

                <label htmlFor="info-22">{strings.details['info-22']}</label>
                <textarea rows="7" name="details-22" className="form-control" />

                <label htmlFor="info-23">{strings.details['info-23']}</label>
                <textarea rows="7" name="details-23" className="form-control" />

                <label htmlFor="info-24">{strings.details['info-24']}</label>
                <textarea rows="7" name="details-24" className="form-control" />

                <label htmlFor="info-25">{strings.details['info-25']}</label>
                <textarea rows="7" name="details-25" className="form-control" />
                <label htmlFor="info-26">{strings.details['info-26']}</label>
                <textarea rows="7" name="details-26" className="form-control" />

                <label htmlFor="info-27">{strings.details['info-27']}</label>
                <textarea rows="7" name="details-27" className="form-control" />

                <label htmlFor="info-28">{strings.details['info-28']}</label>
                <textarea rows="7" name="details-28" className="form-control" />

                <label htmlFor="info-29">{strings.details['info-29']}</label>
                <textarea rows="7" name="details-29" className="form-control" />
